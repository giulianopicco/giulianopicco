  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <span class="uppercase text-sm text-gray-300 font-bold">Name</span>
          <input
        ...
        <div class="mt-8">
          <span class="uppercase text-sm text-gray-300 font-bold">Email</span>
          <input
            onChange={handleChange}
            required
            id="standard-basic"
        ...
        <div class="mt-8">
          ...
          {!submitted ? (
            ...
            <div class="flex justify-center mt-8 items-center font-medium py-4 px-2 bg-white rounded-md text-green-700 bg-green-100 border border-green-300 ">
              <div slot="avatar">
                <svg
              ...
              <div class="flex flex-auto flex-row-reverse" onClick={closeAlert}>
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="100%"
